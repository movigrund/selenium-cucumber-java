...
public class PredefinedStepDefinitions {
	...
	public PredefinedStepDefinitions(){
	...
	{
		baseTest.navigationObj.navigateTo(link);
	}
	...
	{
		baseTest.navigationObj.navigate("forward");
	}
	...
	{
		baseTest.navigationObj.navigate("back");
	}
	...
	{
		baseTest.navigationObj.switchToNewWindow();
	}
	...
	{
		baseTest.navigationObj.switchToOldWindow();
	}
	...
	{
		baseTest.navigationObj.switchToWindowByTitle(windowTitle);
	}
	...
	{
		baseTest.navigationObj.closeNewWindow();
	}
	...
	{
		baseTest.navigationObj.switchFrame(method, value);
	}
	...
	{
		baseTest.navigationObj.switchToDefaultContent();
	}
	...
	{
		baseTest.navigationObj.resizeBrowser(width, heigth);
	}
	...
	{
		baseTest.navigationObj.maximizeBrowser();
	}
	...
	{
		baseTest.navigationObj.closeDriver();
	}
	...
	public void zoom_in()
	{
		baseTest.navigationObj.zoomInOut("ADD");
	}
	...
	{
		baseTest.navigationObj.zoomInOut("SUBTRACT");
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.navigationObj.zoomInOutTillElementDisplay(type,"substract", accessName);
	}
	...
	{
		baseTest.navigationObj.zoomInOut("reset");
	}
	...
	{
		baseTest.navigationObj.scrollPage(to);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.navigationObj.scrollToElement(type, accessName);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.navigationObj.hoverOverElement(type, accessName);
	}
...
//		baseTest.navigationObj.hoverOverElementWithOffset(type, accessName, offsetXNum, offsetYNum);
//	}
	...
	public void check_title(String present,String title) throws TestCaseFailed
	{
		...
		baseTest.assertionObj.checkTitle(title,present.isEmpty());
	}
	...
	{
		//System.out.println("Present :" + present.isEmpty());
		baseTest.assertionObj.checkPartialTitle(partialTextTitle, present.isEmpty());
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.assertionObj.checkElementText(type, value, accessName,present.isEmpty());
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.assertionObj.checkElementPartialText(type, value, accessName, present.isEmpty());
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.assertionObj.checkElementAttribute(type, attrb, value, accessName, present.isEmpty());
	}
	...
	public void check_element_enable(String type, String accessName,String present,String state) throws Exception
	{
		...
		baseTest.assertionObj.checkElementEnable(type, accessName, flag);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.assertionObj.checkElementPresence(type, accessName, present.isEmpty());
	}
	...
	public void is_checkbox_checked(String type, String accessName,String state) throws Exception
	{
		...
		baseTest.assertionObj.isCheckboxChecked(type, accessName, flag);
	}
	...
	public void is_radio_button_selected(String type,String accessName,String state) throws Exception
	{
		...
		baseTest.assertionObj.isRadioButtonSelected(type, accessName, flag);
	}
	...
	public void is_option_from_radio_button_group_selected(String option,String attrb,String type,String accessName,String state) throws Exception
	{
		baseTest.miscmethodObj.validateLocator(type);
		boolean flag = state.equals("selected");
		baseTest.assertionObj.isOptionFromRadioButtonGroupSelected(type,attrb,option,accessName,flag);
	}
	...
	{
		baseTest.assertionObj.checkElementPresence("linkText",accessName,present.isEmpty());
	}
	...
	{
		baseTest.assertionObj.checkElementPresence("partialLinkText", accessName, present.isEmpty());
	}
	...
	{
		baseTest.assertionObj.checkAlertText(actualValue);
	}
	...
	public void is_option_from_dropdown_selected(String option,String by,String type,String accessName,String state) throws Exception
	{
		baseTest.miscmethodObj.validateLocator(type);
		boolean flag = state.equals("selected");
		baseTest.assertionObj.isOptionFromDropdownSelected(type,by,option,accessName,flag);
	}
	...
	public void checkCount(String number, String xpathQuery) throws TestCaseFailed {
		...
		baseTest.assertionObj.checkCount(numberInt, xpathQuery);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.inputObj.enterText(type, text, accessName);
	}
	...
	public void enter_rand_text(String text, String type,String accessName) throws Exception
	{
		...
		baseTest.inputObj.enterText(type, enterText, accessName);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.inputObj.clearText(type, accessName);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.miscmethodObj.validateOptionBy(optionBy);
		baseTest.inputObj.selectOptionFromDropdown(type,optionBy, option, accessName);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.inputObj.selectOptionFromDropdown(type,"selectByIndex", option, accessName);
	}
	...
	public void deselect_option_from_multiselect_dropdown(String option,String optionBy, String type,String accessName) throws Exception
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.miscmethodObj.validateOptionBy(optionBy);
		baseTest.inputObj.deselectOptionFromDropdown(type, optionBy, option, accessName);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.inputObj.deselectOptionFromDropdown(type, "selectByIndex", option, accessName);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.inputObj.unselectAllOptionFromMultiselectDropdown(type, accessName);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.inputObj.checkCheckbox(type, accessName);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.inputObj.uncheckCheckbox(type, accessName);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.inputObj.toggleCheckbox(type, accessName);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.inputObj.selectRadioButton(type, accessName);
	}
	...
	public void select_option_from_radio_btn_group(String option,String by, String type, String accessName) throws Exception
	{
		baseTest.miscmethodObj.validateLocator(type);
		//baseTest.miscmethodObj.validateOptionBy(optionBy);
		baseTest.inputObj.selectOptionFromRadioButtonGroup(type, option, by, accessName);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.clickObj.click(type, accessName);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.clickObj.clickForcefully(type,accessName);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.clickObj.doubleClick(type, accessValue);
	}
	...
	{
		baseTest.clickObj.click("linkText", accessName);
	}
	...
	{
		baseTest.clickObj.click("partialLinkText", accessName);
	}

	@Then("^I submit the form$")
	public void submitForm() {
		baseTest.clickObj.submit("xpath", "//form");
	}
	...
	public void dragAndDrop(String accessTypeSource, String accessValueSource, String accessTypeTarget, String accessValueTarget){
		baseTest.mouseManeuverObj.dragAndDrop(accessTypeSource, accessValueSource, accessTypeTarget, accessValueTarget);
	}
	...
	public void dragAndDropWithOffset(String accessTypeSource, String accessValueSource, String accessTypeTarget, String accessValueTarget, String offsetX, String offsetY){
		baseTest.mouseManeuverObj.dragAndDropWithOffset(accessTypeSource, accessValueSource, accessTypeTarget, accessValueTarget, Integer.parseInt(offsetX), Integer.parseInt(offsetY));
	}

	@Then("^I start dragging at element \"(.*?)\"$")
	public void startDragging(String accessTypeSource, String accessValueSource) {
		baseTest.mouseManeuverObj.startDragging(accessTypeSource, accessValueSource);
	}

	@Then("^I finish dragging by dropping at element \"(.*?)\"$")
	public void finishDragging(String accessTypeTarget, String accessValueTarget) {
		baseTest.mouseManeuverObj.finishDragging(accessTypeTarget, accessValueTarget);
	}
	...
	{
		baseTest.progressObj.wait(time);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.progressObj.waitForElementToDisplay(type, accessName, duration);
	}
	...
	{
		baseTest.miscmethodObj.validateLocator(type);
		baseTest.progressObj.waitForElementToClick(type, accessName, duration);
	}
	...
	{
		baseTest.javascriptObj.handleAlert("accept");
	}
	...
	{
		baseTest.javascriptObj.handleAlert("dismiss");
	}
	...
	{
		baseTest.screenshotObj.takeScreenShot();
	}
	...
	{
		baseTest.configObj.printDesktopConfiguration();
	}
	@After
